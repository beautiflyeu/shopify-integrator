    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-card p-5">
        <div className="flex gap-6">
          {/* Image column — fixed small size */}
          <div className="shrink-0">
            {images.length > 0 ? (
              <>
                <div className="h-[200px] w-[200px] overflow-hidden rounded-md border bg-muted">
          ...
          <div className="min-w-0 flex-1 space-y-4">
                    ...
                    {price.pln && (
                      <>
                        <div>
                          ...
                          <p className="text-base font-medium">{price.pln.net} zł</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">PLN brutto</p>
                          <p className="text-xl font-bold">{price.pln.gross} zł</p>
                        </div>
                      </>
                    )}
                    {price.eur && (
                      <>
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{price.eur.net} €</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">EUR brutto</p>
                          <p className="text-sm text-muted-foreground">{price.eur.gross} €</p>
                        </div>
                      </>
                    )}
                  </div>
            ...
            <div>
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-2xl font-bold">{normalized.inventoryQty ?? 0}</span>
                ...
                <tbody>
                  {parameters.map((p, i) => (
                    <tr key={i} className={i % 2 === 0 ? "bg-muted/40" : "bg-background"}>
                      ...
                      <td className="px-4 py-2">{formatParamValue(p.value, p.unit)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
